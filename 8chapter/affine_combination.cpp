...
int main()
{
    Mat image = imread("./8chapter/image/affine_test5.jpg", 0);
    ...
    imshow("image", image);
    imshow("dst1-rotation", dst1);
    imshow("dst2-zoom", dst2);
    imshow("dst3-rotation_zoom", dst3);
    imshow("dst4-rotation_zoom_transform", dst4);
