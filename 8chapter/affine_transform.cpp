...
int main()
{
    Mat image = imread("./8chapter/image/affine_test3.jpg", 0);
    ...
    imshow("image", image);
    imshow("dst1-affine", dst1); imshow("dst2-affine_rotation", dst2);
    imshow("dst3-affine_OpenCV", dst3); imshow("dst4-affine_rotation_OpenCV", dst4);
